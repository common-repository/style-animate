...
( function( $ ) {
	...
	$.fn.updateColorPicker = function(color) {
		var $input = $(this);
		$input.wpColorPicker( 'color', color );
	}
	$.fn.alphaColorPicker = function(callbackFunc) {

//		return this.each( function() {

			// Scope the vars.
			var $input, startingColor, paletteInput, showOpacity, defaultColor, palette,
				colorPickerOptions, $container, $alphaSlider, alphaVal, sliderOptions, name, value, id;
			...
			colorPickerOptions = {
				change: function( event, ui ) {
					if ($container != undefined) {
						...
						callbackFunc.callback(name,id,value);
					}

				},
				palettes: true // Use the passed in palette.
			};
			...
			//create a hook to call the wpColorPicker function externally
			$input.data('picker',(function(color) {
				$input.wpColorPicker( 'color', color );
